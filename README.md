...
| Role | Status |
|---|---|
| AD DS (Domain Controller) | ✅ Configured |
| AD CS | ✅ Installed |
| DNS | ✅ Configured |
| File and Storage Services | ✅ Configured |
| SMB Share (NETLOGON) | ✅ Created |
...
![Server Manager Dashboard](docs/images/server-manager-dashboard.png)

**AD CS role installed on the domain controller:**

![AD CS in Server Manager](docs/images/adcs-server-manager.png)

**SMB share (NETLOGON) created successfully:**

![SMB Share created](docs/images/smb-share-created.png)

Full step-by-step notes: [docs/setup-guide.md](docs/setup-guide.md)
...
See [docs/setup-guide.md](docs/setup-guide.md) for the full walkthrough, or run the scripts in `scripts/` individually on a fresh Windows Server 2025 VM (as Administrator, in order: AD DS → AD CS → SMB share).
